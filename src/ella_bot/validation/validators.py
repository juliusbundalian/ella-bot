...
ASR_HOMOPHONES: Dict[str, set[str]] = {
    ...
    "c": {"see", "sea"},
    "d": {"dee", "the"},
    "e": {"ee", "eh", "a", "uh", "ah", "ed", "head", "hey", "he", "egg", "it", "the", "in", "eight", "is", "under"},
    "f": {"ef", "eff"},
    "g": {"jee", "gee"},
    "h": {"aitch"},
    "i": {"eye", "aye", "i", "ee", "he", "huh", "e", "in", "it", "is", "his", "if", "eat", "hit", "me", "we", "bee", "here", "high"},
    "j": {"jay"},
    "k": {"kay"},
    "l": {"el", "ell"},
    "m": {"em"},
    "n": {"en", "in", "an"},
    "o": {"oh", "owe", "o", "a", "ah", "all", "or", "on", "of", "off", "old", "go", "so", "no", "who", "to", "you"},
    "p": {"pee", "pea"},
    "q": {"cue", "queue"},
    "r": {"are", "our"},
    "s": {"es", "ess", "is", "as"},
    "t": {"tee", "tea"},
    "u": {"you", "ewe", "u", "uh", "oo", "oh", "to", "do", "who", "two", "through", "blue", "new", "true", "up", "us", "wood", "would"},
    "v": {"vee"},
    "w": {"doubleyou"},
    "x": {"ex"},
    "y": {"why"},
